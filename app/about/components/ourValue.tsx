      ...
      <div className="flex flex-col justify-center items-center">
        <div className="card lg:card-side flex  ">
          ...
          <div className="card-body p-1 flex flex-col font-Helvetica-Neue  max-w-[580px]  text-white">
            ...
            <div className="max-w-[580px] text-wrap  justify-center items-center text-left">
              <p>
              ...
              <div>
                ...
                To embody these 6 values, Kukinians always give our best to
                uphold the critical behaviors of #BukaJalan, #BikinBangga, and
                #BarengBareng.
              </div>
            </div>
          </div>
